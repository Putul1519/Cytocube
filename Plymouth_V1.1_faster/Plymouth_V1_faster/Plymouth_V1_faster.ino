...
if (choice){
  Serial.write(choice);
     ...
     switch(choice){
      ...
      case('a') :        digitalWrite(Xdir,LOW);   delayMicroseconds(10); Xfast();  doXSteps(1000);      
                break;         
      
      case('b') :        digitalWrite(Xdir, HIGH );   delayMicroseconds(10); Xfast();  doXSteps(1000);  
                break; 

      case('5') :        digitalWrite(Xdir,LOW);   delayMicroseconds(1);  doXSteps(500);    
                break;                
      ...
      case('c') :        digitalWrite(Ydir,LOW);   delayMicroseconds(10); YSlow(); doYSteps(1000);    
                break;         
       
      case('d') :        digitalWrite(Ydir, HIGH );   delayMicroseconds(10); YSlow();  doYSteps(1000);  
                break; 
      ...
      case('e') :        digitalWrite(Zdir,LOW);   delayMicroseconds(10); ZSlow(); doZSteps(1000);      
                break;         
       
      case('f') :        digitalWrite(Zdir, HIGH );   delayMicroseconds(10); ZSlow();  doZSteps(1000);  
                break; 
...
void Yfast(){
  digitalWrite(14, HIGH); digitalWrite(2, HIGH); digitalWrite(3, LOW);
}
void Zfast(){
...
void ZSlow(){
  digitalWrite(32, LOW); digitalWrite(30,LOW); digitalWrite(28, HIGH);
}
...
void loadtip(){
  gotohome();
  Zfast();
  digitalWrite(Xdir, LOW);   delayMicroseconds(10);  doXSteps(96500);
  digitalWrite(Ydir, HIGH);   delayMicroseconds(10);  doYSteps(10000);
  digitalWrite(Zdir,HIGH);   delayMicroseconds(10);  doZSteps(52500); 
  delay(2000);
  while (isZ2bumpHit() != 1){
  ZSlow();
  digitalWrite(Zdir,LOW);   delayMicroseconds(10);  doZSteps(1000); 
  }
  digitalWrite(Xdir, HIGH);   delayMicroseconds(10);  doXSteps(20000);
  gotohome();
  extract();
  extract();
  }
...
void goZhome(){
  ...
  Zfast();
  digitalWrite(Zdir, HIGH );   delayMicroseconds(10);  doZSteps(50000);
  digitalWrite(Zdir, HIGH );   delayMicroseconds(10);  doZSteps(4000);
}
void gotohome(){
  Xfast();
  YSlow();
...
void gotodevice(){
  gotohome(); 
  Zfast();
  digitalWrite(Xdir, LOW );   delayMicroseconds(10);  doXSteps(75000); 
  
  digitalWrite(Ydir,HIGH);   delayMicroseconds(10);  doYSteps(100000);

  digitalWrite(Zdir, HIGH );   delayMicroseconds(10);  doZSteps(54500);
...
void dispense(){
   ...
   * 
   ...
   ZSlow();
   digitalWrite(Zdir, LOW );   delayMicroseconds(10);  doZSteps(3000); 
